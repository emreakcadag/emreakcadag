...
<head>
    ...
    <meta charset="UTF-8">
    <title>Emre Akçadağ - CV</title>
    <link href="https://fonts.googleapis.com/css?family=Inconsolata:400,700|Merriweather:300i,400,400i,700"
          rel="stylesheet">
        ...
        <div data-reactroot="">
            ...
            <header>
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="header-left"><h1 class="display-4">Emre Akçadağ</h1>
                                <br>
                                <h2 style="font-size: 28px">Mobile Application Developer<br>Android - Flutter</h2></div>
                        </div>
                    </div>
                </div>
            </header>
