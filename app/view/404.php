 ...
 */
?>
<title>404 | Emre Akçadağ</title>
<body class="permission_denied">
<div id="particles-js"></div>
<div class="denied__wrapper">
    <h1>404</h1>
    <h3>LOST IN <span>SPACE</span> emreakcadag.com <br> Hmm, looks like you're trying to access a page which doesn't exist or you're not allowed to access. But I will not say which one. hehe.</h3>
    ...
    <a>
        <button onclick="history.go(-1);" class="denied__link">Go Back</button>
    </a>
